...
const ChatBox = ({ onClose,profile }) => {
  ...
  //     try {
  //       const response = await axios.get('http://localhost:3000/api/auth/chat', {
  //         headers: {
    ...
    <div className="fixed bottom-0 right-0 mb-4 mr-4">
      <div className="bg-white shadow-md rounded-lg max-w-lg w-full">
        ...
        <div className="p-4 border-b bg-blue-900 text-white rounded-t-lg flex justify-between items-center">
          <p className="text-lg font-semibold">Alumni Name  {profile.age}</p>
          <button
