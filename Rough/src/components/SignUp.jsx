          ...
          <form className="space-y-6"  >
            ...
            <div>
              ...
              <input
                ...
                name="username"
                id="username"
                className=" required bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-500 dark:placeholder-gray-400 "
                placeholder="Fahad"
